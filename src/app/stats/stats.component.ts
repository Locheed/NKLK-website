...
export class StatsComponent implements OnInit {
  public pageTitle: string = "Server statistics by date";
  ...
  onDateChanged(event: any) {
    ...
    this._StatsService.getByDate(date).subscribe(stats => {
      this.stats = stats;
      if (!this.stats) {
        this.serverMessage =
          "Nothing here at the moment... Refreshing databases... try later or pick another date.";
      } else {
        this.serverMessage = "";
      }
